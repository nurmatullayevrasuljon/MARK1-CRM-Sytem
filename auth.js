var AuthSystem = window.AuthSystem = (function () {
    ...
    // TODO: Bu yerga yangi backendning haqiqiy manzilini yozing (masalan https://api.mark1-crm.uz)
    const API_URL = "https://YOUR-NEW-BACKEND-DOMAIN";
    ...
    async function trySignin(kind, phone, password) {
        ...
        return axios.post(`${API_URL}${endpoint}`, payload, { withCredentials: true });
    }
